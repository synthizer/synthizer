...
- The following interfaces are now const-correct:
  ...
  - `syz_globalEchoSetTaps`
- Widen the fields of `syz_RouteConfig` and `syz_EchoTapConfig`  to double, under the assumption that most/all C programs will silently convert floats as needed.

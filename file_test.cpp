...
int main(int argc, char *argv[]) {
  ...
  CHECKED(syz_createSource3D(&source, context, SYZ_PANNER_STRATEGY_DELEGATE, 0.0, 0.0, 0.0, NULL, NULL));
  ...
  CHECKED(syz_createGlobalFdnReverb(&effect, context, NULL, NULL));

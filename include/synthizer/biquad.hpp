 ...
 * when ticking sample-by-sample and trying to use the block-based interface. It would be possible to extend this to support that, but
 * internal components that aren't getting filter configuration from consumers can simply use the IIRFilter.
 * 

...
class RandomGenerator {
	 ...
	 * 
	 * These floats are what you'd get if you converted 16-bit signed samples to floats, i.e. less precise than generateFloat but
	 * still good enough for audio.  This is much faster than generating 1 float 4 times, because
	 * we can get 4 floats from one run of a 64-bit random number generator, as long as we don't mind
	 * the limitation. 
	 * 

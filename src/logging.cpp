...
static const char *logLevelAsString() {
	switch (getLogLevel()) {
		case SYZ_LOG_LEVEL_ERROR: return "error";
		case SYZ_LOG_LEVEL_WARN: return "warn";
		case SYZ_LOG_LEVEL_INFO: return "info";
		case SYZ_LOG_LEVEL_DEBUG: return "debug";
	}
	return "";
}
